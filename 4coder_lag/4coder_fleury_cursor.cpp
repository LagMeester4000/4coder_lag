                                ...
                                ARGB_Color color, b32 open)
{
    ...
    draw_rectangle(app, full_rect_thing, roundness, color);
                    ...
                    f32 roundness, f32 outline_thickness, Frame_Info frame_info)
{
    ...
    FColor cursor_color = fcolor_argb(0x8000ff00);
    ...
    if(!has_highlight_range)
    {
        ...
        for(int i = 0; i < 1; ++i)
        {
            ...
            // NOTE(rjf): Draw cursor.
            {
                ...
                /*for(int glow = 0; glow < 20; ++glow)
                {
                    ...
                    if(alpha > 0)
                    {
                        ...
                        glow_rect.x1 += glow;
                        glow_rect.y1 += glow;
                        Fleury4RenderCursorSymbolThingy(app, glow_rect, roundness + glow*0.4f, 2.f,
            ...
            Fleury4RenderCursorSymbolThingy(app, global_mark_rect, roundness, 2.f,
                                            fcolor_resolve(fcolor_change_alpha(cursor_color, 0.3f)), !cursor_open);
        }
    }
